...
const PostCard = (props) => {
  ...
  return (
    <div className="md:flex lg:h-[250px] md:h-[200px] mb-6 justify-between relative shadow-sm shadow-green-500/70 rounded-2xl">
      ...
      <div className="lg:px-8 px-4 py-4 rounded-b-2xl md:rounded-r-2xl md:rounded-tl-none md:rounded-l-none flex flex-col justify-between overflow-hidden bg-gray-500/10">
